            ...
            <div class="col-md-12 text-center animate-box">
                <div class="results">
                    ...
                    <ul class="list-results-content">
                        ...
                        <li class="col-md-3"><div class="second">                   <span>Nome da Cooperativa</span></div></li>
                        <li class="col-md-1"><div class="second" style="width:84%;"><span class="text-center">00</span></div></li>
                        <li class="col-md-3"><div class="second">                   <span>Cidade</span></div></li>
                    </ul>

                    <div class="desc">
                        <h3>Sorteio Mensal - 20/02/2019 | 01 (um) Renaut Kwind Zen 0Km</h3>
                    </div>
                    <ul class="list-results-head">
                        <li class="col-md-5">Nome:</li>                        
                        <li class="col-md-3">Cooperativa:</li>
                    ...
                    <div class="desc">
                        <h3>Sorteio Mensal - 20/02/2019 | 09 (nove) Renaut Kwind Zen 0Km</h3>
                    </div>
                    <ul class="list-results-head">
                        <li class="col-md-5">Nome:</li>                        
                        <li class="col-md-3">Cooperativa:</li>
